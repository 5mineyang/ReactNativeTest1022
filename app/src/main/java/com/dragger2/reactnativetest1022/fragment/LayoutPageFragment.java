...
public class LayoutPageFragment extends Fragment {
    ...
    public static LayoutPageFragment newInstance(@LayoutRes int sampleLayoutRes, @LayoutRes int practiceLayoutRes) {
        LayoutPageFragment fragment = new LayoutPageFragment();
