package com.dragger2.reactnativetest1022.view.windview;
...
public class PeriscopeLayout extends RelativeLayout {
    ...
    private void init() {
        ...
        Drawable red = getResources().getDrawable(R.drawable.book1);
        Drawable yellow = getResources().getDrawable(R.drawable.book6);
        Drawable blue = getResources().getDrawable(R.drawable.book10);
